-- Portfolio Manager — migration 0001_init (Neon). See docs/adr/0001.
-- This is the APPLIED schema (run via `npm run db:migrate`). It creates the
-- structure only; the dual-write that POPULATES it is OFF by default and gated
-- on Phase 1. Generated by hand from the contracts
--   (original design notes: docs/db/schema-draft.sql)
