...
1. **[2026-07-20] Proposal lineage must include every entry path**
   Do instead: keep scheduled discovery, Lab, exit-monitor, intraday-stop, and dashboard manual proposals in the Phase 1 source inventory; do not enable a lineage cutover until each uses the same reviewed contract.
2. **[2026-07-20] Research and monitoring holdings must come from verified strategy ownership**
...
3. **[2026-07-20] Event and review timestamps require typed proof**
...
4. **[2026-07-11] Unattributed lots are quarantined until explicitly resolved**
...
5. **[2026-07-11] Strategy ownership governs exits**
...
6. **[2026-07-11] Agent 4 is a bounded portfolio manager**
...
7. **[2026-06-18] Backend is read-only with Robinhood**
