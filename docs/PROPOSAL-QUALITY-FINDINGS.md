...
The current system is capable of producing a real proposal that is strong enough to
survive its evaluator and enter Sam's approval queue. The best current judgment is:

- **About 78% confidence** that a genuinely qualifying setup will become a valid,
  evaluator-approved proposal.
- **About 90% confidence** that weak, incomplete, stale, malformed, or operationally
  unsafe recommendations will be refused.
- **About 60% confidence** that the first evaluator-approved proposal will already be
...
These are informed engineering judgments, not statistical confidence intervals and
not a claim of investment edge.
