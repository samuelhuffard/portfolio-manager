...
### Agent Three absolute-threshold table — long-horizon consistency

Apply these bands to the absolute component of each submetric. Percentages shown are the percentage of that submetric's maximum points. Agent Three uses multi-year persistence rather than Agent One or Two's short-window acceleration.

| Agent Three submetric | 100% of submetric points | 75% | 50% | 0% |
|---|---|---|---|---|
| Durable revenue-growth consistency (20) | 3-year revenue CAGR ≥15%, positive growth in every year, no year below 10%, and maximum annual-growth spread ≤15 percentage points | CAGR 10–<15% with positive growth every year, or CAGR ≥15% with one volatile year | CAGR 5–<10% with positive growth in at least 2 of 3 years | CAGR <5%, two negative years, or materially erratic growth |
| Latest revenue quality or beat (5) | Latest revenue beat ≥3% and YoY growth is non-decelerating | Beat 1–<3% | Result within ±1% of consensus with positive YoY growth | Miss >1% or material deterioration |
| Normalized multi-year EPS trajectory (12) | 3-year normalized EPS CAGR ≥15%, positive in every year, and no annual decline worse than 10% | CAGR 10–<15% with positive cumulative trajectory | CAGR 5–<10% and no persistent two-year decline | CAGR <5% or persistent deterioration |
| Long-horizon estimate revisions (18) | Next-12-month EPS consensus rises ≥5% over 90 days, positive breadth ≥70%, and no net 30-day reversal | Consensus rises 2–<5% over 90 days and positive breadth ≥60% | Consensus rises 0–<2% with nonnegative breadth | Net downward revision over 90 days |
| Structural margin trend (8) | Cumulative expansion ≥200 bps over 3 years with no 2-year contraction sequence | Expansion 100–199 bps over 3 years | Stable within ±99 bps over 3 years | Contraction ≥100 bps without a documented structural investment explanation |
| Balance-sheet durability (12) | Latest and 3-year median show net cash or net debt/EBITDA <1× and interest coverage >8×, with no year below the next band | Latest and median leverage 1–2× and coverage >5× | Latest and median leverage 2–3× and coverage >3× | Leverage >3×, coverage <3×, or material multi-year deterioration |
| Institutional ownership direction (7) | Ownership increases ≥5 percentage points YoY or clear multi-quarter net accumulation | Increase 2–<5 points | Stable within approximately ±2 points | Decline >2 points |
| 13F accumulation (8) | Aggregate institutional shares increase in each of the latest 2 reported quarters and cumulative increase is ≥5% | Latest-quarter increase ≥2% and no decline in the preceding quarter | Stable within approximately ±2% | Latest-quarter decline >2% or net decline across 2 quarters |
...
**Agent Three long-horizon overlay for special sectors:** apply the revenue and earnings growth bands to the 3-year CAGR and require positive growth in at least 2 of the latest 3 years. Apply profitability and balance-sheet bands to both the latest value and the 3-year median; full points require both to satisfy the full band, while any latest value more than one band worse than the median controls the result.

**Agent Three hard valuation gate under thin-peer fallback:** the hard valuation gate in Section 6 passes only when the applicable valuation cascade earns at least 75% of the valuation submetric points, unless the proposal supplies the existing rigorous, falsifiable normalized-earnings exception. The 84-point thin-peer entry cap still applies.
