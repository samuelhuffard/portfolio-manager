...
// Phase 0 clean-day evidence needs a full observation window. Keep enough
// headroom for a retry storm on one slot without evicting that day's other
// scheduled slots before the 90-day evidence window expires.
export const JOB_HISTORY_TTL_SECONDS = 90 * 24 * 60 * 60;
export const JOB_HISTORY_MAX = 500;
