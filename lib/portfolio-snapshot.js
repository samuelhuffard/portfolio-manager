...
export async function writePortfolioSnapshot({ sheets, spreadsheetId, sheetIds, holdings, cash, spyPrice, timestamp, holdingsNote, sourceRequestId = null }) {
  ...
  await shadowReplacePositions(positionsProjectionFromHoldings(holdings));
