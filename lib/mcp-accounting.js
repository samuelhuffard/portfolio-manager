...
export function validateMcpFillInput({ proposal, existingTrades = [], orderId, ticker, side, shares, price, agentId }) {
  ...
  const amountDiffPct = Math.abs(amount - proposal.amountDollars) / proposal.amountDollars;
