 ...
 * written to the Sheet. Sam executes trades manually — this is research
...
Respond with ONLY a single JSON object — no markdown fences, no commentary before or after — matching exactly this shape:
{
  ...
  "risks": ["<specific risk>", "..."],
  "kill_criteria": ["<condition that would make you reverse this call>", "..."],
  "confidence": <number 0-1>
}

For HOLD, risks/kill_criteria may be empty arrays. For BUY or SELL you MUST include at least one risk and one kill criterion — a downstream rule check rejects BUY/SELL proposals that omit them.`;
