...
- Never use a stock's per-share price, an inability to buy one whole share, or a "significant number of shares" as a reason to HOLD or avoid a BUY.
- Judge a proposed BUY by its dollar allocation relative to the portfolio, evidence, risk limits, and available cash. If those support a positive allocation, a fractional share is valid.`;
...
export async function getAIRecommendation({
  ...
  researchHistory, boundaryToken, evaluatorCritique, previousProposal, agentId, budget, factEvidence,
...
${newsBlock}`;
  ...
  return { ...parseRecommendation(text, ticker, evidenceIds), evidencePacket };
}
