...
const RESEARCH_DECISION_TOOL = Object.freeze({
  ...
  input_schema: {
    ...
    properties: {
      ...
      target_weight_pct: { type: "number", minimum: 0, maximum: 10 },
      thesis: { type: "string" },
      ...
      kill_criteria: { type: "array", items: { type: "string" }, maxItems: 2 },
      ...
      suspect_evidence: { type: "array", items: { type: "string" }, maxItems: 5 },
    },
