...
export function isResearchPromptMemory(memory) {
  ...
  // cross-ticker research guidance. Their historic rationale is supplied via
  // the per-ticker research ledger; injecting a legacy decision globally made
  // old BUY language appear in every prompt and repeatedly trip the model's
  // untrusted-memory safeguard.
