...
export const LEGACY_AUDIT_START_AT = "2026-07-21T00:00:00.000Z";
...
export function legacyRecommendationToDecisionAudit(row, { agentId, sheetRow } = {}) {
  ...
  return normalizeResearchDecisionAudit({
    ...
    proposalDisposition: "historical_recommendation_not_queued",
    ...
    kairosExplanation: ["This historical research recommendation did not retain a candidate-level Kairos trace."],
  });
}
